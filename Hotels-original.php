								...
								<div class="form_container room_spec_class">
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="form-group ui-widget">
											...
											<input name="location_for_search" type="text" id="location_for_search" placeholder="Please, enter location" class="form-control" autocomplete="on" required value="Dubai">


											<input name="hidden_location_for_search" type="text" id="hidden_location_for_search" hidden value="Dubai, DU, United Arab Emirates" >
									...
									<input name="check_in" id="check_in" type='text' class="form-control" value="2017-01-07" required="required" readonly/>
