...
<!--
					...
					<div class="extra_wrapper">
						<a href="IptalIadeKosullari.php">
							<strong class="col4"></strong>
						</a>
						<strong class="col4">
							<a href="IptalIadeKosullari.php"></a>
						</strong>
						<a href="IptalIadeKosullari.php"> 
							<br>Yanlış anlaşılmalardan kaçınmak için tüm değişiklikler ve iptaller Bookingroll
			...
			<div class="col-md-12">        
				<div class="copy">
					<div class="f_logo">
						...
						<img src="images/footerlogo.png" alt="BookingRoll">
